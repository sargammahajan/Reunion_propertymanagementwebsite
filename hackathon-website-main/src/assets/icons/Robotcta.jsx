...
const Robotcta = () => {
  return (
    <div>
        ...
        <path d="M36.7188 10.2812H10.2812C7.84775 10.2812 5.875 12.254 5.875 14.6875V35.25C5.875 37.6835 7.84775 39.6562 10.2812 39.6562H36.7188C39.1523 39.6562 41.125 37.6835 41.125 35.25V14.6875C41.125 12.254 39.1523 10.2812 36.7188 10.2812Z" stroke="#0FA958" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M30.1094 26.4375H16.8906C14.8627 26.4375 13.2188 28.0815 13.2188 30.1094C13.2188 32.1373 14.8627 33.7812 16.8906 33.7812H30.1094C32.1373 33.7812 33.7812 32.1373 33.7812 30.1094C33.7812 28.0815 32.1373 26.4375 30.1094 26.4375Z" stroke="#0FA958" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
